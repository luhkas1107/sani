...
public class Mascara {
	...
	public static AbstractFormatter setMaskCnpjInTf(JFormattedTextField ftCnpj) throws java.text.ParseException {
		MaskFormatter mk = new MaskFormatter("##.###.###/####-##");
		mk.setValidCharacters("0123456789");
		return mk;
	}
	
	public static AbstractFormatter setMaskInscrEstadualInTf(JFormattedTextField ftInscEstadual) throws java.text.ParseException {
		MaskFormatter mk = new MaskFormatter("###.###.###.###");
		mk.setValidCharacters("0123456789");
		return mk;
	}
