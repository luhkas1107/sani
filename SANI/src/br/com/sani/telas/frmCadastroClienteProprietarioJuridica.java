...
public class frmCadastroClienteProprietarioJuridica extends JFrame {
	...
	private int modo = 0;
	private ClienteProprietarioJuridica cadastro;
	...
	public frmCadastroClienteProprietarioJuridica(ClienteProprietarioJuridica cadastro){
		try {
			montarComponentes();			
			if(cadastro != null){
				modoEdicao(cadastro);
	...
	public void montarComponentes() throws ParseException {
		...
		btnLimpar.setIcon(new ImageIcon(frmCadastroClienteProprietarioJuridica.class.getResource("/br/com/images/clear.png")));
		...
		btnCancelar.setIcon(new ImageIcon(frmCadastroClienteProprietarioJuridica.class.getResource("/br/com/images/delete-.png")));
		...
		btnSalvar.setIcon(new ImageIcon(frmCadastroClienteProprietarioJuridica.class.getResource("/br/com/images/apply-.png")));
	...
	private ClienteProprietarioJuridica getBean() throws EntradaUsuarioException, ParseException{
		
		//primeiro eu instancio a classe pai que deve ser inserida primeiro
		ClienteProprietario cliProprietario = new ClienteProprietario();
		
		//preencho com os dados necessarios fazendo a validação de campos obrigatórios
		cliProprietario.setCep(TelaUtil.getCep(ftCep, true));
		cliProprietario.setNumeroEndereco(TelaUtil.getCampoObrigatorio(txtNumeroResidencia, true));
		cliProprietario.setComplementoEndereco(TelaUtil.getCampoObrigatorio(txtComplemento, false)); //false quando nao é obrig.
		cliProprietario.setTelefone(TelaUtil.getTelefone(ftTelefone, false));
		cliProprietario.setCelular(TelaUtil.getCelular(ftCelular, true));
		
		//verifica se está em modo edição, se estiver ele seta o id do cadastro que deseja alterar
		if(this.modo  == 1){
			cliProprietario.setCodCliProprietario(cadastro.getClienteProprietario().getCodCliProprietario());
		}
		
		//agora eu vou instancia a classe filha que depende de um ID que ja foi inserido para ser inserida
		ClienteProprietarioJuridica cliJur = new ClienteProprietarioJuridica();
	...
	private void salvar(){
		try{
			ClienteProprietarioJuridica bean = getBean(); //mando ele coletar os dados da tela e validadar
			ClienteProprietarioJuridicaDAO dao = new ClienteProprietarioJuridicaDAO(); //intancio a dao
			
			dao.inserirClienteProprietarioJuridica(bean);//chamo o metodo inserir e passo o bean como parametro
	...
	private void atualizar(){
		try{
			...
			dao.atualizarClienteProprietarioJuridica(bean);//chamo o metodo atualizar e passo o bean como parametro
	...
	private void modoEdicao(ClienteProprietarioJuridica cadastro){
		...
		txtComplemento.setText(cadastro.getClienteProprietario().getComplementoEndereco());
		txtNumeroResidencia.setText(cadastro.getClienteProprietario().getNumeroEndereco());
		ftCelular.setText(cadastro.getClienteProprietario().getCelular());
		ftCep.setText(cadastro.getClienteProprietario().getCep());
