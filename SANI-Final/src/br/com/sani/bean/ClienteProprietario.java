...
public class ClienteProprietario {
	...
	private String tipoPropriedadeClienteProprietario;
	private String siteClienteProprietario;
	
	SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
	
	public ClienteProprietario(String data){
		try {
	...
	//Métodos ClienteProprietário
	
	private String getTipoPropriedade() {
		return tipoPropriedadeClienteProprietario;
	}
	private void setTipoPropriedade(String tipoPropriedade) {
		if (tipoPropriedade.equals("") || tipoPropriedade.equals(null)) {
			JOptionPane.showMessageDialog(null, "Campo Tipo Propriedade OBRIGATÓRIO!");
		} else {
			this.tipoPropriedadeClienteProprietario = tipoPropriedadeClienteProprietario;
		}
	}
	...
	public void setSiteClienteProprietario(String siteClienteProprietario) {
		this.siteClienteProprietario = siteClienteProprietario;
	}

	public String getSiteClienteProprietario() {
		return siteClienteProprietario;
	}
}
