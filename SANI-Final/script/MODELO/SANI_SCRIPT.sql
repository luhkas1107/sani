...
CREATE
  ...
  (
    ...
    CONSTRAINT "TB_CLIENTE_COMPRADOR PK" PRIMARY KEY CLUSTERED (
    COD_CLI_COMPRADOR)
WITH
  (
    ALLOW_PAGE_LOCKS = ON ,
...
CREATE
  ...
  (
    ...
    SEXO_PESSOA       CHAR (1) NOT NULL DEFAULT 'F' ,
    EST_CIVIL_PESSOA  CHAR (1) NOT NULL ,
...
CREATE
  ...
  (
    ...
    SEXO_CORRETOR      CHAR (1) NOT NULL DEFAULT 'F' ,
    DT_NASCIMENTO      DATE NOT NULL ,
    EST_CIVIL_CORRETOR CHAR (1) NOT NULL ,
...
CREATE
  ...
  (
    ...
    NR_ENDERECO          NUMERIC (11) NOT NULL ,
    COMPL_ENDERECO       VARCHAR (255) ,
    TP_IMOVEL            CHAR (2) NOT NULL DEFAULT 'AP' ,
    ST_IMOVEL            CHAR (2) NOT NULL DEFAULT 'DV' ,
...
CHECK
(
  TP_IMOVEL IN ('AP', 'CA', 'GA', 'IR', 'PR', 'SA', 'SO', 'TE')
)
GO
ALTER TABLE TB_IMOVEL
ADD
...
CREATE
  ...
  (
    ...
    ESTADO_PROPOSTA   CHAR (1) NOT NULL DEFAULT 'N' ,
    ST_PROPOSTA       CHAR (1) NOT NULL DEFAULT 'A' ,
...
ALTER TABLE TB_PROPOSTA
ADD CONSTRAINT FK_CLI_COMPRADOR_PROP FOREIGN KEY
(
COD_CLI_COMPRADOR
)
...
ADD CONSTRAINT FK_CLI_COMPR_PESS_JURIDICA FOREIGN KEY
(
COD_CLI_COMPRADOR
)
REFERENCES TB_CLIENTE_COMPRADOR
